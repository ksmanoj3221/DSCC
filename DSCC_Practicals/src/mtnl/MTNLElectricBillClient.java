...
public class MTNLElectricBillClient {
    public static void main(String[] args) {
        try {
            // Lookup the remote object
            MTNLElectricBillService electricBillService = (MTNLElectricBillService) Naming.lookup("rmi://localhost/MTNLElectricBillService");
            ...
            while (true) {
                ...
                switch (expression) {
                    case "1":
                        ...
                        System.out.println("Bills in the MTNL Bill Database:");
                        for (Bill bill : bills) {
